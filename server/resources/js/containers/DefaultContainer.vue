  ...
  <div class="app">
    <AppHeader fixed>
      ...
      <b-link class="navbar-brand" to="/dashboard">
        <img class="navbar-brand-full" src="/img/brand/logo.svg" width="150" height="33" alt="Laforêt" />
        <img class="navbar-brand-minimized" src="/img/brand/logo-mini.svg" width="40" height="40" alt="Laforêt" />
      </b-link>
