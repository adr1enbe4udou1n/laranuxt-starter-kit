...
It's just a show-case automatised way to generate api client code. You're of course free to use directly [Axios Module](https://github.com/nuxt-community/axios-module) in place of it.
